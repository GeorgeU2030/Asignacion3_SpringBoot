  ...
  return (
    ...
    <nav className='bg-primary h-16'>
      <div className='flex justify-between items-center'>
        ...
        <button onClick={() => goPage(1)} className='bg-second py-2 px-4 text-white rounded-md hover:bg-third mr-5'>Movies</button>
        <button onClick={() => goPage(2)} className='bg-second py-2 px-4 text-white rounded-md hover:bg-third mr-5'>Directors</button>
